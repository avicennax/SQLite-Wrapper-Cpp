...
//! SQLite3-Wrapper library namespace 
	...
	class Database
	{
		public:
			...
			*/
			...
			//!  Destructor
			//*! Frees SQLite3 database connection. */
			~Database();
			...
			*/
			...
			/*!
				...
				Where [n] is the respective vector sizes + 1
			...
			*/
			...
			//! If a SELECT query is made, the results of the query are stored in a re-sizable std::vector.
			/*!
				...
				Ex:	queryResults contains 3 records and 4 columns.
					...
					[0][0]: id		[0][1]: name  		[0][2]: age  		[0][3]: gender
					[1][0]: 1	  	[1][1]: John   		[1][2]: 23	    	[1][3]: Male
			...
			*/
			...
			//! Error message returned by sqlite3 function describing nature/location of error.
			string errorMs;
